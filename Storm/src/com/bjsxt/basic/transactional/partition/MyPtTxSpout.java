package com.bjsxt.basic.transactional.partition;
...
public class MyPtTxSpout implements IPartitionedTransactionalSpout<MyMeta>{
	...
	@Override
	public backtype.storm.transactional.partitioned.IPartitionedTransactionalSpout.Emitter<MyMeta> getEmitter(
			Map conf, TopologyContext context) {
	...
	public class MyEmitter implements IPartitionedTransactionalSpout.Emitter<MyMeta>
	{
		...
		@Override
		public MyMeta emitPartitionBatchNew(TransactionAttempt tx,
				BatchOutputCollector collector, int partition,
