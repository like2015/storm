...
public class DateFmt {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(DateFmt.getCountDate("2017-02-21 12:13:14", DateFmt.date_short));
		System.out.println(parseDate("2017-02-21").after(parseDate("2014-02-20")));
	}
